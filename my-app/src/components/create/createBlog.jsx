...
const CreateBlog=()=>{
    ...
    return(
        ...
        <StyledForm>
            ...
            <StyledInput placeholder="Title" onChange={(e)=>{onInputChange(e)}} name='title'/>
            <StyledButton variant='contained' onClick={()=>savePost()}>Publish</StyledButton>
        </StyledForm>
        <StyledTextarea placeholder='Tell your story...'minRows={5} onChange={(e)=>{onInputChange(e)}} name='description' />
        </Component>
    )
}
